...
.rg-popup.rg-compact{width:min(560px,94vw);min-height:45vh;max-height:82vh;font:clamp(12px,1.05vw,16px)/1.3 Arial,sans-serif;border-color:#294665;border-radius:12px;background:linear-gradient(145deg,#101e2c,#08131e)}
...
.rg-compact .rg-popup-primary{width:100%;justify-content:center;margin:0;font-size:14px;min-height:20px}.rg-compact .rg-popup-body{overflow:visible;padding:2px 12px;flex:1}.rg-connection-flow{display:flex;align-items:center;justify-content:center;gap:10px;padding:0 18px 3px}.rg-flow-node{display:flex;align-items:center;flex-direction:column;min-width:80px;color:#c9dfef;position:relative;font-size:12px}.rg-flow-node img{width:26px;height:24px;object-fit:contain}.rg-flow-node>svg{width:26px;height:24px}.rg-flow-node small{display:none}.rg-flow-line{height:2px;flex:1;background:#304b60;max-width:120px;transition:background .16s}.rg-flow-line[data-ready=true]{background:#87da91}.rg-flow-line[data-active=true]{background:#39d8ff;animation:rg-popup-pulse 1.4s ease-in-out infinite}
...
.rg-compact details{margin-top:3px}.rg-compact summary{font-size:12px;padding:3px 0}.rg-details-scroll{max-height:22vh;overflow-y:auto;overscroll-behavior:contain;padding-right:6px}.rg-details-scroll:focus-visible{outline:2px solid #39d8ff;outline-offset:-2px}.rg-compact .rg-popup-footer{flex-wrap:nowrap;align-items:center;padding:3px 10px;gap:8px}.rg-compact .rg-popup-footer button{width:auto!important;max-width:max-content!important;flex:0 0 auto!important;min-width:0!important;background:transparent!important;border-color:transparent!important;padding:3px 4px!important;min-height:28px!important;font-size:12px!important}.rg-compact .rg-popup-guidance{width:auto;flex:1;text-align:center;font-size:11px}.rg-key{display:inline-grid;place-items:center;flex:0 0 auto;box-sizing:border-box;width:22px;height:22px;margin-right:6px;padding:1px 0 0;border:1px solid #6099b8;border-radius:50%;background:linear-gradient(#20455b,#0a2538);box-shadow:inset 0 1px 0 #ffffff12;color:#72e5ff;font:700 11px/1 Arial,sans-serif;letter-spacing:0;text-align:center;vertical-align:middle}.rg-popup-footer button:has(>.rg-key){display:inline-flex!important;align-items:center;white-space:nowrap}.rg-popup-footer button:focus-visible .rg-key,.rg-popup-footer button.gpfocus .rg-key{border-color:#72e5ff;background:linear-gradient(#2a6a8a,#0f3a52)}
...
.rg-popup.rg-compact{width:min(560px,92vw)}.rg-flow-node{min-width:65px}.rg-core-result span:last-child{max-width:70px}}
