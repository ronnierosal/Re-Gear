...
const controlArtwork: Readonly<Record<string, V3ProductionArtworkId>> = {
  ...
  "disconnect-sleep": "disconnect-sleep", "portable-shutdown": "disconnect-shutdown",
  "disconnect-shutdown": "disconnect-shutdown", "egpu-device": "egpu",
  "egpu-dock": "egpu", "egpu-display": "display", "egpu-render": "gpu-load",
