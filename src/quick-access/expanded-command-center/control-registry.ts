...
export const controlRegistry:readonly ControlDefinition[]=[
 ...
 entry({id:'disconnect-sleep',sourceKeys:['egpu:disconnect-sleep'],label:'Sleep — Keep eGPU Connected',shortLabel:'Sleep Connected',icon:'disconnect-sleep',domain:'egpu',type:'action',nativeTab:'egpu',capability:null,directAction:'sleep-connected'}),
