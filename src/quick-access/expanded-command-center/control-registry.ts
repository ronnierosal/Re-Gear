...
export const controlRegistry:readonly ControlDefinition[]=[
 ...
 entry({id:'about',sourceKeys:['settings:about'],label:'About Re-Gear',shortLabel:'About',icon:'about',domain:'system',type:'navigation',nativeTab:null,capability:'about',directAction:null,quickEligible:false,nativeVisible:false}),
