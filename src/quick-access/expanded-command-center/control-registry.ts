...
export const controlRegistry:readonly ControlDefinition[]=[
 ...
 entry({id:'disconnect-sleep',sourceKeys:['egpu:disconnect-sleep'],label:'Disconnect + Sleep',shortLabel:'Disconnect + Sleep',icon:'disconnect-sleep',domain:'egpu',type:'action',nativeTab:'egpu',capability:'guarded-disconnect-sleep',directAction:'disconnect-sleep'}),
