...
/* The selected Quick tab already names the page. Do not repeat that hierarchy. */
...
.rg-expanded-tile-heading{display:flex;align-items:center;gap:6px;width:100%;min-width:0}.rg-expanded-tile-icon{position:static;display:grid;place-items:center;flex:0 0 auto;width:25px;height:25px;margin:0;border:1px solid #315c75;border-radius:7px;background:#0a2232;color:#c4e7f8}.rg-expanded-tile-icon svg{width:18px;height:18px}
...
/* Brightness/volume are part of the main Command Center, not floating cards. */
...
/* Detached thumb rail scales with viewport and stays visually secondary. */
...
@media(max-height:520px){
  ...
  .rg-expanded .rg-expanded-tile{min-height:78px;padding:6px}.rg-expanded-tile-icon{width:22px;height:22px;border-radius:6px}.rg-expanded-tile-icon svg{width:15px;height:15px}.rg-expanded-label{font-size:10px}.rg-expanded-value{font-size:12px}.rg-expanded-detail{font-size:8.5px;line-height:1.2}.rg-expanded-chevron{font-size:18px}
...
@media(max-width:900px){.rg-expanded{width:76vw}}
@media(max-width:760px){.rg-expanded-backdrop{padding-left:2vw}.rg-expanded{width:78vw}.rg-expanded-frame{max-width:98vw}.rg-expanded-frame>.rg-utility-rail[data-utility-side=right]{right:1.5vw}}
@media(max-width:620px){.rg-expanded{width:80vw}.rg-expanded-frame>.rg-utility-rail[data-utility-side=right]{width:64px}.rg-expanded-frame>.rg-utility-rail[data-utility-side=left]{width:62px}.rg-expanded:has(.rg-expanded-tab[data-ec-tab=quick][aria-selected=true]) .rg-expanded-content:not(:has(.rg-expanded-detail-page)){padding-left:74px}}
`;