...
function LivePanel({store, close, switchTv}: {store: Store; close(): void; switchTv(): void}) {
  ...
  return <ConfirmModal strTitle="G1 connection progress" strOKButtonText={status.canSwitch ? "Switch to TV" : "Hide"} strCancelButtonText="Hide" bDisableBackgroundDismiss={true} bHideCloseIcon={true}
...
export function showConnectionLivePanel(store: Store, switchTv: () => void, onClose: () => void) {
