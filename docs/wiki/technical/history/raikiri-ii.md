...
4. Share a reviewed report through [Help Improve Re-Gear](../../player/help-improve.md), linked to #23. Vendor activation/capture is a separately supervised investigation, not a general setup step.
...
[Controllers](../../player/controllers.md) · [Troubleshooting](../../player/troubleshooting.md)
