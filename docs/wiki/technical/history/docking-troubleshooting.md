...
firmware versions or builds. Start with the general [eGPU guide](../../player/egpu.md)
for placement and workflow concepts.

## 2. Situation (what / where / when)

The [September 2 incident](docking-incident.md) records supervised
...
3. Use only the supported guarded action in the coordinated test plan. If readiness is unknown, stop and collect a reviewed support preview through [Troubleshooting](../../player/troubleshooting.md).
...
[eGPU and Docking](../../player/egpu.md) · [Safety and eGPU Handling](../../player/safety.md)
· [Confirmed Hardware Testing](../hardware-evidence.md)
· [Original September 2 incident](docking-incident.md)
