...
> Historical September 2 evidence. Statements about pending candidates below describe that session, not the current build. See [Current State](../current-state.md) for the maintained summary.
...
See [Troubleshooting](../../player/troubleshooting.md),
[Safety and eGPU Handling](../../player/safety.md), and
