...
The [historical docking incident](history/docking-incident.md) preserves the earlier causal chain. See [Current State](current-state.md) for current capability limits and [Troubleshooting](../player/troubleshooting.md) for the information to include in a bug report.
