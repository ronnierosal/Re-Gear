...
See **[Confirmed Hardware Testing](../technical/hardware-evidence.md)** for the capability-by-capability test ledger and **[Offline Play Readiness](offline-readiness.md)** for game checks.
