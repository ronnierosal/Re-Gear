...
[Current State](Current-State.md) links merged work and remaining integration gates.
[Safety and eGPU Handling](Safety-and-eGPU-Handling.md) explains today's handling rules;
[Confirmed Hardware Testing](Confirmed-Hardware-Testing.md) preserves actual observed
results. Tests of code never upgrade those historical device results.

## Troubleshooting and lessons

For the recorded device-specific issues, see
[Ally X and GPD G1 troubleshooting](Ally-X-and-GPD-G1-Troubleshooting.md).
...
with [Ally X and GPD G1 troubleshooting](Ally-X-and-GPD-G1-Troubleshooting.md).
