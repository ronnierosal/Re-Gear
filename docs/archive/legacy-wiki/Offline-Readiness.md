...
Re-Gear development source includes selected-game readiness guidance using local Steam evidence. See [Current State](Current-State.md) and [source review](https://github.com/ronnierosal/Re-Gear/blob/main/docs/OFFLINE_EVIDENCE_SOURCE_REVIEW.md).
...
See [Confirmed Hardware Testing](Confirmed-Hardware-Testing.md) for recorded device results. This Wiki does not claim that every game, or any particular untested game, will work offline.
