...
[Fixes and issue tracking](Issues-Fixed.md).
...
Never include private addresses, credentials, raw identifiers, or unrestricted logs. Follow [Safety and eGPU Handling](Safety-and-eGPU-Handling.md): fully shut down before eGPU disconnect under the current tested policy, even when Portable appears normal.
