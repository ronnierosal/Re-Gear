...
The [historical docking incident](Ally-X-and-GPD-G1-Docking-Incident.md) preserves the earlier causal chain. See [Current State](Current-State.md) for current capability limits and [Troubleshooting](Troubleshooting.md) for the information to include in a bug report.
