...
4. Share a reviewed report through [Help Improve Re-Gear](Help-Improve-Re-Gear.md), linked to #23. Vendor activation/capture is a separately supervised investigation, not a general setup step.
...
[Controllers](Controllers.md) · [Troubleshooting](Troubleshooting.md)
