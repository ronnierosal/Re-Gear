...
- [Ally X and GPD G1](Ally-X-and-GPD-G1-Troubleshooting.md): display/audio, retained resources, shutdown and later source fixes.
- [Raikiri II extra buttons](Raikiri-II-Troubleshooting.md): transport differences, vendor-event research and mapping limits.
...
[historical device-specific incident](Ally-X-and-GPD-G1-Docking-Incident.md).
...
Start with [Help Improve Re-Gear](Help-Improve-Re-Gear.md) for support-preview steps, optional diagnostic commands, and a report checklist.
