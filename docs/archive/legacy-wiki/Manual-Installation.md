...
must follow their exact supervised [Getting Started](Getting-Started.md) baseline.
...
- Wait for a Re-Gear release explicitly approved for your hardware and installation
  path. Check [Current State](Current-State.md) and [Supported Hardware](Supported-Hardware.md).
...
- Read [Permissions and privacy](Diagnostics-and-Privacy.md#why-re-gear-requests-root-permission)
  and [Safety and eGPU Handling](Safety-and-eGPU-Handling.md) before proceeding.
...
rollback plan; other users should seek help through [Troubleshooting](Troubleshooting.md).
