...
See **[Confirmed Hardware Testing](Confirmed-Hardware-Testing.md)** for the capability-by-capability test ledger and **[Offline Play Readiness](Offline-Readiness.md)** for game checks.
