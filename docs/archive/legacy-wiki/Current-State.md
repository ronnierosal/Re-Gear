...
| Controllers | Routing/diagnostic foundations; gyro research [#154](https://github.com/ronnierosal/Re-Gear/pull/154) open | Broader configuration, gyro, rumble, LEDs and player order are not established working features; see [Controllers](Controllers.md) |
...
[Confirmed Hardware Testing](Confirmed-Hardware-Testing.md) for the dated entries
and their limits.
...
[Confirmed Hardware Testing](Confirmed-Hardware-Testing.md) for the dated ledger.
...
[Safety and eGPU Handling](Safety-and-eGPU-Handling.md). Development toward a live
