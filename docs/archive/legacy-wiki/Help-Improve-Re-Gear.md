...
perform a hardware test. Follow [Safety and eGPU Handling](Safety-and-eGPU-Handling.md).
...
[Confirmed Hardware Testing](Confirmed-Hardware-Testing.md); do not turn a community
