...
SPEC = importlib.util.spec_from_file_location("ally_deploy_helper", ROOT / "scripts" / "ally_deploy_helper.py")
...
class AllyDeployHelperTests(unittest.TestCase):
    ...
    def test_helper_restarts_only_the_fixed_plugin_loader_after_replacement(self):
        source = (ROOT / "scripts" / "ally_deploy_helper.py").read_text(encoding="utf-8")
