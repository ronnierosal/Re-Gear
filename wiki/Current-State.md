...
| Software removal | Operator tool [#122](https://github.com/ronnierosal/Re-Gear/pull/122) landed through [#148](https://github.com/ronnierosal/Re-Gear/pull/148); the sequence made executable in [#181](https://github.com/ronnierosal/Re-Gear/pull/181) and run end to end on hardware on September 9 | A backend RPC exists ([#195](https://github.com/ronnierosal/Re-Gear/pull/195), closing [#146](https://github.com/ronnierosal/Re-Gear/issues/146)) but has not itself run on a device; no player-facing UI yet |
...
- Exercise the backend RPC on a device. [#146](https://github.com/ronnierosal/Re-Gear/issues/146) is closed by [#195](https://github.com/ronnierosal/Re-Gear/pull/195), but the RPC composes the sequence with an automated restart step in place of an operator, and that substitution has not run on hardware.
