...
![Temporary Re-Gear Command Center mockup](../assets/wiki/mockups/command-center-overview.svg)
...
**Priority:** complete native D-pad, Back, focus and scrolling checks, then replace temporary mockups with real Decky screenshots. Game-close and sleep integration remains dependent on the owning eGPU flow work. See [Current State](Current-State).
