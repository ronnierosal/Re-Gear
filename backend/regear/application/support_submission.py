...
#: This endpoint is dormant and has never issued a report id, so its first
#: production contract uses only the current Re-Gear prefix.
REPORT_ID_RE = re.compile(r"^RG-[A-Z0-9]{6,16}$")
