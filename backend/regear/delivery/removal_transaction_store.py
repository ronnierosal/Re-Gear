...
`regear.ports.removal_transaction` states the ordering this has to support: the
...
`regear.domain.removal_transaction.reconcile`'s question, and this module never
