...
` + `
  ...
  // Normal sleep stays connected and uses its separate coordinator. The
  // disconnect selector exposes only the verified disconnect and shutdown
  // routes; reconnect and disconnect-before-sleep remain absent.
