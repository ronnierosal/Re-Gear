...
const read=new AsyncFunction('optionalDiagnostics','expandedVisible','quickAccessVisible','diagnosticsOnScreen','nextPayload','getPeripheralStatus',source.slice(start,end)+'return nextPeripheral;');
