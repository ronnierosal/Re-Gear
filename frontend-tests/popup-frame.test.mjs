...
function harness(options={}){
 ...
 const make=new Function('hooks','Date','setTimeout','clearTimeout','setInterval','clearInterval','window',jsx+`const {useSyncExternalStore,useEffect,useReducer,useRef}=hooks;const Focusable='focus',ModalRoot='root',ConnectionProgressOverlay='overlay',connectionPanelCss='';const connectionProgressViewModel=s=>s;`+live.replace(/export /g,'')+';return LivePanel;');
