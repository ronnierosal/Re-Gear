...
const brandImagePath = fileURLToPath(new URL("./docs/images/re-gear-decky-black-gear.jpg", import.meta.url));
config.plugins.unshift({
  name: "re-gear-brand-image",
  resolveId(source) {
    if (source === "../docs/images/re-gear-decky-black-gear.jpg") return "\0re-gear-brand-image";
    return null;
  },
  load(id) {
